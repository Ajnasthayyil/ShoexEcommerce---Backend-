...
namespace ShoexEcommerce.Application.Interfaces.Order
{
    ...
    {
        Task<ApiResponse<PlaceOrderResponseDto>> PlaceOrderAsync(int userId, PlaceOrderDto dto, CancellationToken ct = default);
        Task<ApiResponse<PlaceOrderResponseDto>> BuyNowAsync(int userId, BuyNowDto dto, CancellationToken ct = default);
        Task<ApiResponse<string>> VerifyAndConfirmOrderAsync(int userId, ShoexEcommerce.Application.DTOs.Payment.VerifyPaymentDto dto, CancellationToken ct = default);
        ...
        Task<ApiResponse<string>> CancelOrderAsync(int userId, int orderId, string reason, CancellationToken ct = default);
